        ...
        <div class="row">
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse menu" id="bs-example-navbar-collapse-1">
                    ...
                    <form class="navbar-form navbar-left" role="search" action="processSearchContributor.php">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Search by contributor name"
...
Name Of The Contributors Who Contributed Artifacts
</h1>';
...
echo '<th>Contributor Birthday</th>';
echo '<th>Contributor Profession</th>';
echo '<th>Artifact Name</th>';
echo '<th>Artifact Category</th>';

...
<div id="page">
    ...
    <div id="contentMine">
        <div class="post">
            <h1 class="title text-center">Add New Forces </h1>
            <div class="entry">
                <br><br>
                <?php
                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddForces.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="fullname">Rank : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"> <i
                                                    class="glyphicon glyphicon-user"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="rank"
                                                   type='text' name='rank'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="username">Forces type : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="forces type" required type='text'
                                                   name='forcesType'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="password">Nation : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="nation"
                                                   type='text' required name='nation'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="password">Chief : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="chief"
                                                   type='text' required name='chief'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="password">Manpower : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="manpower"
                                                   type='text' required name='manpower'>
                                        </div>
                                    </div>
                                </div>

...
$exNO      = (int)htmlspecialchars($_POST['exNO']);
$NID       = (int)htmlspecialchars($_POST['NID']);


$stmt = 'INSERT INTO EXHIBITION_CONTRIBUTORS
        (,NID)
        VALUES(:EXIBITION_NO,:NID)';



$stid = oci_parse($c1, $stmt);

oci_bind_by_name($stid, ':EXIBITION_NO', $exNO);

                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddLocation.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="floor"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="section" required type='text'
                                                   name='section'>
                                        </div>
                                    </div>
                                </div>

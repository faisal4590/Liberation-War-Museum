...
!function ($)
{
    ...
    $.fn.fileuploader = function (q)
    {
        return this.each(function (t, r)
        {
            var s = $(r), p = null, o = null, l = null, sl = [], n = $.extend(!0, {}, $.fn.fileuploader.defaults, q),
                f = {
                    init: function ()
                    {
                        return s.closest(".fileuploader").length || s.wrap('<div class="fileuploader"></div>'), p = s.closest(".fileuploader"), f.set("attrOpts"), f.isSupported() ? (!n.beforeRender || !$.isFunction(n.beforeRender) || n.beforeRender(p, s) !== !1) && (f.redesign(), n.files && f.files.append(n.files), f.rendered = !0, n.afterRender && $.isFunction(n.afterRender) ? n.afterRender(l, p, o, s) : null, void(f.disabled || f.bindUnbindEvents(!0))) : (n.onSupportError && $.isFunction(n.onSupportError) ? n.onSupportError(p, s) : null, !1)
                    },
                    bindUnbindEvents: function (a)
                    {
                        a && f.bindUnbindEvents(!1), s[a ? "on" : "off"](f._assets.getAllEvents(), f.onEvent), n.changeInput && o !== s && o[a ? "on" : "off"]("click", f.clickHandler), n.dragDrop && f.isUploadMode() && n.dragDrop.container.length && (n.dragDrop.container[a ? "on" : "off"]("drag dragstart dragend dragover dragenter dragleave drop", function (a)
                        {
                            a.preventDefault()
                    ...
                    {
                        return a.preventDefault(), f.clipboard._timer ? void f.clipboard.clean() : void s.click()
                    },
                    onEvent: function (a)
                    {
                        switch (a.type)
                        ...
                        n.listeners && $.isFunction(n.listeners[a.type]) ? n.listeners[a.type].call(s, p) : null
                    },
                    set: function (a, b)
                    {
                        switch (a)
                        {
                                ...
                                for (var d in c)
                                {
                                    ...
                                    if (f._assets.hasAttr(e))
                                    {
                                        switch (c[d])
                                        {
                                            ...
                                            case"listInput":
                                                n[c[d]] = ["true",
                                                    "false"].indexOf(s.attr(e)) > -1 ? "true" == s.attr(e) : s.attr(e);
                                                break;
                                            case"extensions":
                            ...
                            case"disabled":
                                ...
                                break;
                            case"feedback":
                                b || (b = f._assets.textParse(f._itFl.length > 0 ? n.captions.feedback2 : n.captions.feedback, {length: f._itFl.length})), $(!o.is(":file")) ? o.find(".fileuploader-input-caption span").html(b) : null;
                                break;
                            case"input":
                            ...
                            case"nextInput":
                                ...
                                f.bindUnbindEvents(!1), sl.length > 0 && 0 == sl[sl.length - 1].get(0).files.length ? s = sl[sl.length - 1] : (sl.indexOf(s) == -1 ? sl.push(s) : null, sl.push(g), s.after(s = g)), f.bindUnbindEvents(!0);
                                break;
                            case"listInput":
                    ...
                    onChange: function (a, b)
                    {
                        ...
                        if (b)
                        {
                            if (!b.length)
                            {
                                return f.set("input", ""), f.files.clear(), !1;
                            }
                            c = b
                        }
                        if (f.clipboard._timer && f.clipboard.clean(), !f.isDefaultMode() || (f.reset(), 0 != c.length))
                        {
                            ...
                            {
                                var g = c[e], h = f._itFl[f.files.add(g, "choosed")], i = f.files.check(h, c, 0 == e);
                                if (i === !0)
                                {
                                    n.thumbnails && f.thumbnails.item(h), f.isUploadMode() && f.upload.prepare(h), n.onSelect && $.isFunction(n.onSelect) ? n.onSelect(h, l, p, o, s) : null, d++;
                                }
                                else if (f.files.remove(h, !0), i[2] || (f.isDefaultMode() && (f.set("input", ""), f.reset(), i[3] = !0), i[1] ? n.dialogs.alert(i[1]) : null), i[3])
                                {
                                    break
                                }
                            }
                            f.isUploadMode() && d > 0 && f.set("input", ""), f.set("feedback", null), f.isAddMoreMode() && d > 0 && f.set("nextInput"), f.set("listInput", null), n.afterSelect && $.isFunction(n.afterSelect) ? n.afterSelect(l, p, o, s) : null
                        }
                    },
                    thumbnails: {
                        create: function ()
                        {
                            null != n.thumbnails.beforeShow && $.isFunction(n.thumbnails.beforeShow) ? n.thumbnails.beforeShow(p, o, s) : null;
                            ...
                            {
                                if (a.preventDefault(), f.locked)
                                {
                                    return !1;
                                }
                                var b = $(this).closest(n.thumbnails._selectors.item), c = f.files.find(b);
                                c && f.upload.send(c, !0)
                        ...
                        item: function (a)
                        {
                            ...
                            }, f.thumbnails.renderImage(a), null != n.thumbnails.onItemShow && $.isFunction(n.thumbnails.onItemShow) ? n.thumbnails.onItemShow(a, l, p, o, s) : null
                        },
                        generateFileIcon: function (a, b)
                        {
                            var c = '<div style="${style}" class="fileuploader-item-icon${class}"><i>' + (b ? b : "") + "</i></div>",
                                d = f._assets.textToColor(b);
                            if (d)
                            {
                                var e = f._assets.isBrightColor(d);
                                e && (c = c.replace("${class}", " is-bright-color")), c = c.replace("${style}", "background-color: " + d)
                            }
                            return c.replace("${style}", "").replace("${class}", "")
                        },
                        renderImage: function (a, b)
                        {
                            var c = a.html.find(".fileuploader-item-image"), d = function (b)
                            {
                                var d = $(b);
                                d.is("img") && d.on("load error", function (b)
                                {
                                    "error" == b.type && e(), g(), null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) ? n.thumbnails.onImageLoaded(a, l, p, o, s) : null
                                }), d.is("canvas") && (null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) ? n.thumbnails.onImageLoaded(a, l, p, o, s) : null), c.removeClass("fileupload-no-thumbnail fileuploader-loading").html(d)
                            }, e = function ()
                            {
                            ...
                            {
                                if (n.thumbnails.synchronImages && (f._pfrL.indexOf(a) != -1 || b ? null : f._pfrL.push(a), f._pfrL.length > 1 && !b))
                                {
                                    return;
                                }
                                var h = new FileReader, i = function (a)
                                {
                                    if (n.thumbnails.canvasImage)
                                    {
                                        var b = document.createElement("canvas"), h = b.getContext("2d"), i = new Image;
                                        i.onload = function ()
                                        {
                                            var a = n.thumbnails.canvasImage.height ? n.thumbnails.canvasImage.height : c.height(),
                                                ...
                                                k = i.height / a, l = i.width / j, m = k < l ? k : l, o = i.height / m,
                                                p = i.width / m, q = Math.ceil(Math.log(i.width / p) / Math.log(2));
                                ...
                                return void("string" == typeof a.file ? i({target: {result: a.file}}) : (h.onload = i, h.readAsDataURL(a.file)))
                            }
                            e()
                        }
                    },
                    upload: {
                        ...
                        send: function (a, b)
                        {
                            if (a.upload)
                            {
                                ...
                                }, d = function ()
                                {
                                    ...
                                    if (f._pfuL.length > 0)
                                    {
                                        for (f._pfuL.indexOf(a) > -1 ? f._pfuL.splice(f._pfuL.indexOf(a), 1) : null; b < f._pfuL.length;)
                                        {
                                ...
                                {
                                    if (a.upload.status = "pending", a.html && c(), b)
                                    {
                                        f._pfuL.indexOf(a) > -1 ? f._pfuL.splice(f._pfuL.indexOf(a), 1) : null;
                                    }
                                    else if (f._pfuL.indexOf(a) == -1 ? f._pfuL.push(a) : null, f._pfuL.length > 1)
                                    {
                                        return;
                                    }
                                }
                                if (n.upload.beforeSend && $.isFunction(n.upload.beforeSend) && n.upload.beforeSend(a, l, p, o, s) === !1)
                                {
                                    return c(), void d();
                                }
                                ...
                                {
                                    var b = $.ajaxSettings.xhr(), c = new Date;
                                ...
                                }, a.upload.complete = function (a, b)
                                {
                                    ...
                                    }), c && (p.removeClass("fileuploader-is-uploading"), null != n.upload.onComplete && "function" == typeof n.upload.onComplete ? n.upload.onComplete(l, p, o, s, a, b) : null)
                                }, a.upload.success = function (b, d, e)
                                {
                                    a.uploaded = !0, delete a.upload, a.upload = {status: "successful"}, a.html && c(), f.set("listInput", null), null != n.upload.onSuccess && $.isFunction(n.upload.onSuccess) ? n.upload.onSuccess(b, a, l, p, o, s, d, e) : null
                                }, a.upload.error = function (b, d, e)
                                {
                                    a.uploaded = !1, a.upload.status = "cancelled" == a.upload.status ? a.upload.status : "failed", delete a.upload.$ajax, a.html && c(), null != n.upload.onError && $.isFunction(n.upload.onError) ? n.upload.onError(a, l, p, o, s, b, d, e) : null
                                }, a.upload.$ajax = $.ajax(a.upload)
                            }
                        },
                        cancel: function (a)
                        {
                            a && a.upload && (a.upload.status = "cancelled", a.upload.$ajax ? a.upload.$ajax.abort() : null, delete a.upload.$ajax, f.files.remove(a))
                        },
                        retry: function (a)
                        {
                        ...
                        progressHandling: function (a, b, c)
                        {
                            ...
                            {
                                var d = a.loaded, e = a.total, g = Math.round(100 * d / e),
                                    h = ((new Date).getTime() - c.getTime()) / 1e3, i = h ? d / h : 0, j = e - d,
                                    k = h ? j / i : null, m = {
                                        loaded: d,
                                ...
                                n.upload.onProgress && $.isFunction(n.upload.onProgress) ? n.upload.onProgress(m, b, l, p, o, s) : null
                            }
                        }
                    },
                    dragDrop: {
                        ...
                        {
                            clearTimeout(f.dragDrop._timer), n.dragDrop.container.addClass("fileuploader-dragging"), f.set("feedback", f._assets.textParse(n.captions.drop)), null != n.dragDrop.onDragEnter && $.isFunction(n.dragDrop.onDragEnter) ? n.dragDrop.onDragEnter(a, l, p, o, s) : null
                        },
                        onDragLeave: function (a)
                        {
                            clearTimeout(f.dragDrop._timer), f.dragDrop._timer = setTimeout(function (a)
                            {
                                return !!f.dragDrop._dragLeaveCheck(a) && (n.dragDrop.container.removeClass("fileuploader-dragging"), f.set("feedback", null), void(null != n.dragDrop.onDragLeave && $.isFunction(n.dragDrop.onDragLeave) ? n.dragDrop.onDragLeave(a, l, p, o, s) : null))
                            }, 100, a)
                        },
                        onDrop: function (a)
                        {
                            clearTimeout(f.dragDrop._timer), n.dragDrop.container.removeClass("fileuploader-dragging"), f.set("feedback", null), a && a.originalEvent && a.originalEvent.dataTransfer && a.originalEvent.dataTransfer.files && a.originalEvent.dataTransfer.files.length && f.onChange(a, a.originalEvent.dataTransfer.files), null != n.dragDrop.onDrop && $.isFunction(n.dragDrop.onDrop) ? n.dragDrop.onDrop(a, l, p, o, s) : null
                        },
                    ...
                    clipboard: {
                        paste: function (a)
                        {
                            if (f._assets.isIntoView(o) && a.originalEvent.clipboardData && a.originalEvent.clipboardData.items && a.originalEvent.clipboardData.items.length)
                            {
                                ...
                                {
                                    if (b[c].type.indexOf("image") !== -1 || b[c].type.indexOf("text/uri-list") !== -1)
                                    {
                                        var d = b[c].getAsFile(), e = new Date, g = function (a)
                                        {
                                            return a < 10 && (a = "0" + a), a
                                        }, h = n.clipboardPaste > 1 ? n.clipboardPaste : 2e3;
                                        d && (d.name = "Clipboard " + e.getFullYear() + "-" + g(e.getMonth() + 1) + "-" + g(e.getDate()) + " " + g(e.getHours()) + "-" + g(e.getMinutes()) + "-" + g(e.getSeconds()), d.name += d.type.indexOf("/") != -1 ? "." + d.type.split("/")[1].toString().toLowerCase() : ".png", f.set("feedback", f._assets.textParse(n.captions.paste, {ms: h / 1e3})), f.clipboard._timer = setTimeout(function ()
                                        {
                    ...
                    files: {
                        add: function (a, b)
                        {
                            var l, m, c = a.name, d = a.size, e = f._assets.bytesToText(d), g = a.type,
                                h = g ? g.split("/", 1).toString().toLowerCase() : "",
                                i = c.indexOf(".") != -1 ? c.split(".").pop().toLowerCase() : "",
                                j = c.substr(0, c.length - (c.indexOf(".") != -1 ? i.length + 1 : i.length)),
                                k = a.data, a = a.file || a;
                            return f._itFl.push({
                                name: c,
                                title: j,
                        ...
                        check: function (a, b, c)
                        {
                            ...
                            {
                                return d[1] = f._assets.textParse(n.captions.errors.filesLimit), d[3] = !0, d;
                            }
                            if (null != n.maxSize && c)
                            {
                                var e = 0;
                                ...
                                {
                                    return d[1] = f._assets.textParse(n.captions.errors.filesSizeAll), d[3] = !0, d
                                }
                            }
                            if (null != n.onFilesCheck && $.isFunction(n.onFilesCheck) && c)
                            {
                                var g = n.onFilesCheck(b, n, l, p, o, s);
                                if (g === !1)
                                {
                                    return d[3] = !0, d
                                }
                            }
                            if (null != n.extensions && $.inArray(a.extension, n.extensions) == -1 && $.inArray(a.type, n.extensions) == -1)
                            {
                                return d[1] = f._assets.textParse(n.captions.errors.filesType, a), d;
                            }
                            if (null != n.fileMaxSize && a.size > 1e6 * n.fileMaxSize)
                            {
                                return d[1] = f._assets.textParse(n.captions.errors.fileSize, a), d;
                            }
                            if (4096 == a.size && "" == a.type)
                            {
                                return d[1] = f._assets.textParse(n.captions.errors.folderUpload, a), d;
                            }
                            var e = !1;
                            return $.each(f._itFl, function (b, c)
                            {
                                ...
                                {
                                    return e = !0, c.file.size != a.size || c.file.type != a.type || a.file.lastModified && c.file.lastModified && c.file.lastModified != a.file.lastModified ? (d[1] = f._assets.textParse(n.captions.errors.fileName, a), d[2] = !1) : d[2] = !0, !1
                                }
                            }), !e || d
                        },
                        append: function (a)
                        {
                            if (a = $.isArray(a) ? a : [a], a.length)
                            {
                                ...
                                {
                                    b = f._itFl[f.files.add(a[c], "appended")], n.thumbnails ? f.thumbnails.item(b) : null;
                                }
                                return f.set("feedback", null), f.set("listInput", null), n.afterSelect && $.isFunction(n.afterSelect) ? n.afterSelect(l, p, o, s) : null, 1 != a.length || b
                            }
                        },
                        find: function (a)
                        {
                        ...
                        remove: function (a, b)
                        {
                            if (b || !n.onRemove || !$.isFunction(n.onRemove) || n.onRemove(a, l, p, o, s) !== !1)
                            {
                                ...
                                f._pfrL.indexOf(a) > -1 ? f._pfrL.splice(f._pfrL.indexOf(a), 1) : null, f._pfuL.indexOf(a) > -1 ? f._pfuL.splice(f._pfuL.indexOf(a), 1) : null, f._itFl.indexOf(a) > -1 ? f._itFl.splice(f._itFl.indexOf(a), 1) : null, a = null, 0 == f._itFl.length ? f.reset() : null, f.set("feedback", null), f.set("listInput", null)
                            }
                        },
                        getItemAttr: function (a, b)
                        {
                            var c = null;
                            return a && ("undefined" != typeof a[b] ? c = a[b] : a.data && "undefined" != typeof a.data[b] && (c = a.data[b])), c
                        },
                        clear: function (a)
                        {
                            ...
                            {
                                var c = f._itFl[b];
                                a || !c.appended ? (c.html && (c.html ? f._itFl[b].html.remove() : null), c.upload && c.upload.$ajax && f.upload.cancel(c), f._itFl.splice(b, 1)) : b++
                            }
                            f.set("feedback", null), f.set("listInput", null), 0 == f._itFl.length && n.onEmpty && ($.isFunction(n.onEmpty), !0) ? n.onEmpty(l, p, o, s) : null
                        }
                    },
                    reset: function (a)
                    {
                    ...
                    _assets: {
                        ...
                        copyAllAttributes: function (a, b)
                        {
                            ...
                            {
                                "required" != this.name && a.attr(this.name, this.value)
                        ...
                        getAllEvents: function (a)
                        {
                            ...
                            return b.indexOf("change") == -1 && b.push("change"), b.join(" ")
                        },
                        isIntoView: function (a)
                        {
                            var b = $(window).scrollTop(), c = b + window.innerHeight, d = a.offset().top,
                                e = d + a.outerHeight();
                            return b < d && c > e
                        },
                        isBlankCanvas: function (a)
                        {
                            var b = document.createElement("canvas"), c = !1;
                        ...
                        textParse: function (text, opts, noOptions)
                        {
                            ...
                            }, opts), typeof text)
                            {
                                case"string":
                                    ...
                                    {
                                        var a = a.replace(/ /g, ""),
                                            r = "undefined" != typeof opts[a] && null != opts[a] ? opts[a] : "";
                        ...
                        isBrightColor: function (a)
                        {
                            ...
                            {
                                var b;
                                return a && a.constructor == Array && 3 == a.length ? a : (b = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) ? [parseInt(b[1]),
                                    parseInt(b[2]),
                                    parseInt(b[3])] : (b = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(a)) ? [2.55 * parseFloat(b[1]),
                                    2.55 * parseFloat(b[2]),
                                    2.55 * parseFloat(b[3])] : (b = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) ? [parseInt(b[1], 16),
                                    parseInt(b[2], 16),
                                    parseInt(b[3], 16)] : (b = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(a)) ? [parseInt(b[1] + b[1], 16),
                                    parseInt(b[2] + b[2], 16),
                                    parseInt(b[3] + b[3], 16)] : "undefined" != typeof colors ? colors[$.trim(a).toLowerCase()] : null
                            }, c = function (a)
                            {
                                var c = b(a);
        ...
        thumbnails: {
            ...
            {
                a.children().animate({opacity: 0}, 200, function ()
                {
                    setTimeout(function ()
                    {

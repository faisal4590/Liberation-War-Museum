                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddSectors.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="fullname">Sector Commander : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"> <i
                                                    class="glyphicon glyphicon-user"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="sector commander"
                                                   type='text' name='sectorCommander'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="username">Sector Manpower : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="sector manpower" type='text'
                                                   name='sectorManpower'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="password">Sector Raising Day : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder=""
                                                   type='date' required name='sectorRaisingDay'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="password">Date Of Independence : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="date of"
                                                   type='date' required name='dateOfIndependence'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="username">Important Battle Fought : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="Important Battle Fought " type='text'
                                                   name='battleFought'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="username">Death Toll : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="death toll" type='text'
                                                   name='deathToll'>
                                        </div>
                                    </div>
                                </div>

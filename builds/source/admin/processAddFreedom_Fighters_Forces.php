...
$forcesType       = htmlspecialchars($_POST['forces_type']);


$stmt = 'INSERT INTO freedom_fighters_forces
        (freedom_fighter_id,forces_type)
        VALUES(:freedom_fighter_id,:forces_type)';

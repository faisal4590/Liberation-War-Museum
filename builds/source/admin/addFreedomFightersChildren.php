...
<div id="page">
    ...
    <div id="contentMine">
        <div class="post">
            <h1 class="title text-center">Add New Freedom Fighters Children</h1>
            <div class="entry">
                <br><br>
                <?php
                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddFreedomFightersChildren.php" method="post" enctype="multipart/form-data">

                                <?php
                                $conn = oci_connect("system", "faisal4590", "localhost/faisal");
                                $stid = oci_parse($conn, 'SELECT * FROM FREEDOM_FIGHTERS');
                                ...
                                {
                                    $temp[$var1++] = $row['FREEDOM_FIGHTER_ID'];
                                }
                                //oci_close($conn);
                                ?>
                                <div class="form-group">
                                    <label for="fullname">SELECT FREEDOM FIGHTER ID : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"> <i
                                                        class="glyphicon glyphicon-user"></i></span>
                                        <div class="icon-addon">
                                            <select name="freedomFighterID" class="form-control" style="height: 30px;">
                                                <?php
                                                for ($p = 0; $p < $var1; $p++)
                                                {
                                ...
                                <div class="form-group">
                                    <label for="username">Children Name : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="Children Name"  type='text'
                                                   name='childrenName'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="password">Children Gender : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="Children Gender"
                                                   type='text'  name='childrenGender'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="password">Children's Date Of Birth : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                ...
                                <div class="form-group">
                                    <label style="font-size: 18px;" for="bookImage">Upload Freedom Fighters Image</label><br>

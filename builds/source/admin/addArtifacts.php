...
<div id="page">
    ...
    <div id="contentMine">
        <div class="post">
            <h1 class="title text-center">Add New Artifacts</h1>
            <div class="entry">
                <br><br>
                <?php
                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddArtifacts.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="fullname">Artifact Name : </label>
                                ...
                                <div class="form-group">
                                    <label for="username">Artifact Category : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                ...
                                <div class="form-group">
                                    <label for="password">Artifact Date Of Retrieval : </label>
                                    <div class="input-group">

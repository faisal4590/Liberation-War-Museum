                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddSectorAreaCovered.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="fullname">Sector no : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"> <i
                                                    class="glyphicon glyphicon-user"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="sector no"
                                                   type='text' name='sectorNo'>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="username">Sector Area Name : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                ...
                                <div class="form-group">
                                    <label for="password">Sector Area Size : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="Sector Area Size "
                                                   type='number' name='sizeOfArea'>
                                        </div>
                                    </div>
                                </div>

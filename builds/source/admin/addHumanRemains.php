...
<div id="page">
    ...
    <div id="contentMine">
        <div class="post">
            <h1 class="title text-center">Add New HumanRemains</h1>
            <div class="entry">
                <br><br>
                <?php
                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddHumanRemains.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="fullname">SELECT ARTIFACT ID : </label>
                                ...
                                <div class="form-group">
                                    <label for="password">Body Tags : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="body tags"
                                                   type='text'  name='bodyTag'>
                                        </div>
                                    </div>
                                </div>

								<div class="form-group">
                                    <label for="password">Recovery Place  : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="recovery place"
                                                   type='text' required name='recoveryPlace'>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <label for="username">Date of Martyrdom: </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="date of martyrdom" required type='date'
											...
											<div class="form-group">
                                    <label for="username">Body Parts Found: </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="body parts found" required type='text'
                                                   name='bodyPartsFound'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label style="font-size: 18px;" for="bookImage">Upload HumanRemains Image</label><br>
                                    <input type='file' name='HumanRemainsImage'>
                                </div>

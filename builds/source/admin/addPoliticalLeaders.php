                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddPoliticalLeaders.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="fullname">Political Leaders Name : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"> <i
                                                    class="glyphicon glyphicon-user"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="political leaders name"
                                                   type='text' name='name'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="username">Fathers Name : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="mothers name"
                                                   type='text' required name='mothersName'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="date of "
                                ...
                                <div class="form-group">
                                    <label for="password">Recognition :  </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="recognition"
                                                   type='text' required name='recognition'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="spouse"
                                                   type='text' required name='spouse'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label style="font-size: 18px;" for="bookImage">Upload Political Leader Image</label><br>
                                    <input type='file' name='politicalLeaderImage'>
                                </div>

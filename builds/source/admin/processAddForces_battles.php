...
$forceNAME       = htmlspecialchars($_POST['forceNAME']);
$battleName       = htmlspecialchars($_POST['battleName']);


$stmt = 'INSERT INTO FORCES_BATTLES
        (FORCES_TYPE,BATTLE_NAME)
        VALUES(:FORCES_TYPE,:BATTLE_NAME)';



$stid = oci_parse($c1, $stmt);

oci_bind_by_name($stid, ':FORCES_TYPE', $forceNAME);

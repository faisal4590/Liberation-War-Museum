...
<head>
    ...
    <title>Add Artifact and contributors</title>
</head>
<body>
<?php
include "header.php";
...
<div id="page">
    ...
    <div id="contentMine">
        <div class="post">
            <h1 class="title text-center">Add Artifact and contributors</h1>
            <div class="entry">
                <br><br>
                <?php
                ...
                <div class="container wow rotateInDownLeft" data-wow-delay="0.35s" style="max-width: 500px;visibility: visible;
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddArtifact_contributors.php" method="post" enctype="multipart/form-data">
                                <?php
                                ...
                                ?>
                                <div class="form-group">
                                    <label for="fullname">SELECT NID No : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"> <i
                                                    class="glyphicon glyphicon-user"></i></span>
                                        <div class="icon-addon">

...
$martyrId       = (int)htmlspecialchars($_POST['martyr_id']);
$artifactID       = (int)htmlspecialchars($_POST['artifact_id']);


$stmt = 'INSERT INTO martyrs_artifacts
        (martyr_id,artifact_id)
        VALUES(:martyr_id,:artifact_id)';

...
$galleryNo       = (int)htmlspecialchars($_POST['gallery_no']);
$roomNo       = (int)htmlspecialchars($_POST['room_no']);


$stmt = 'INSERT INTO gallery_location
        (gallery_no,room_no)
        VALUES(:gallery_no,:room_no)';
...
oci_bind_by_name($stid, ':room_no', $roomNo);

...
$warCriminalID       = (int)htmlspecialchars($_POST['war_criminal_id']);
$imageID       = (int)htmlspecialchars($_POST['image_id']);


$stmt = 'INSERT INTO war_criminal_images
        (war_criminal_id,image_id)
        VALUES(:war_criminal_id,:image_id)';



$stid = oci_parse($c1, $stmt);

oci_bind_by_name($stid, ':war_criminal_id', $warCriminalID);
oci_bind_by_name($stid, ':image_id', $imageID);

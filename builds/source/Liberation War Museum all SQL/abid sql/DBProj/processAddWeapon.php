...
if (!empty($_POST))
{
	...
	$artifactId           = htmlspecialchars($_POST['artifactId']); 
    $weaponCapacity           = htmlspecialchars($_POST['weaponCapacity']); 
	$weaponCost           = htmlspecialchars($_POST['weaponCost']);
	$weaponModel           = htmlspecialchars($_POST['weaponModel']);
	$weaponWeight           = htmlspecialchars($_POST['weaponWeight']);
	$weaponManufacturer           = htmlspecialchars($_POST['weaponManufacturer']);

                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddArt.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="date of establishment"
                                                   type='date' required name='dateOfEstablishment'>
                                        </div>
                                    </div>
                                </div>
								
								<div class="form-group">
                                    <label for="username">Inagurated by : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="inagurated by" required type='text'
                                                   name='inaguratedBy'>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <label for="username">Opening hours: </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="opening hours" required type='datetime-local'
                                                   name='openingHours'>
                                        </div>
                                    </div>
                                </div>

...
<div id="page">
    ...
    <div id="contentMine">
        <div class="post">
            <h1 class="title text-center">Add New Weapon</h1>
            <div class="entry">
                <br><br>
                <?php
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-8">
                            <form action="processAddArt.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="password">Weapon capacity  : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="weapon capacity"
                                                   type='text' required name='weaponCapacity'>
                                        </div>
                                    </div>
                                </div>
								
								<div class="form-group">
                                    <label for="password">Weapon cost : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control" placeholder="weapon cost "
                                                   type='number' required name='weaponCost'>
                                        </div>
                                    </div>
                                </div>
								
								<div class="form-group">
                                    <label for="username">Weapon model : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="weapon model" required type='text'
                                                   name='weaponModel'>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <label for="username">Weapon weight : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="weapon weight " required type='text'
                                                   name='weaponWeight'>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <label for="username">Weapon Manufacturer : </label>
                                    <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="fa fa-dollar"></i></span>
                                        <div class="icon-addon">
                                            <input class="form-control"
                                                   placeholder="weapon manufacturer" required type='text'

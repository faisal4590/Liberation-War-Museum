...
if (!empty($_POST))
{
    ...
    $artName           = htmlspecialchars($_POST['artName']);  //name paste from prev file
    $artWorthValue             =htmlspecialchars($_POST['artWorthValue']);
    $dateOfPainting      = htmlspecialchars(date('m.d.y', strtotime($_POST['dateOfPainting'])));// date er jonno
    $dateOfRetrieval        = htmlspecialchars(date('m.d.y', strtotime($_POST['dateOfRetrieval'])));

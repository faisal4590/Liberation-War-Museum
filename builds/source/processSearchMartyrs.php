...
<?php
$inputValue = strtolower(htmlspecialchars($_GET['searchMartyr']));
...
$stid = oci_parse($conn, "SELECT MARTYRS.MARTYR_NAME,
 MARTYRS.MARTYR_DOB,MARTYRS.MARTYR_DATE_OF_MARTYRDOM,
 MARTYRS.MARTYR_PROFESSION
 FROM MARTYRS WHERE MARTYR_NAME
LIKE '%" . $_GET['searchMartyr'] . "%' ");
...
echo '<thead>';
echo '<tr>';
echo '<th class="active">Martyr Name</th>';
echo '<th class="active">Martyr Birthday</th>';
echo '<th class="active">Date Of Martyrdom</th>';
echo '<th class="active">Martyr Profession</th>';
echo '</tr>';
echo '</thead>';
echo '<tbody>';

...
<?php
$inputValue = strtolower(htmlspecialchars($_GET['searchPoliticalLeaders']));
...
$stid = oci_parse($conn, "SELECT UNIQUE POLITICAL_LEADERS.NAME,
POLITICAL_LEADERS.DATE_OF_BIRTH,POLITICAL_LEADERS.GENDER
, POLITICAL_LEADERS.PROFESSION,POLITICAL_LEADERS.RECOGNITION
 FROM POLITICAL_LEADERS WHERE POLITICAL_LEADERS.NAME
LIKE '%" . $_GET['searchPoliticalLeaders'] . "%' ");
...
echo '<thead>';
echo '<tr>';
echo '<th class="active">Political Leader Name</th>';
echo '<th class="active">Political Leader Birthday</th>';
echo '<th class="active">Political Leader Gender</th>';
echo '<th class="active">Political Leader Profession</th>';
echo '<th class="active">Political Leader Recognition</th>';
echo '</tr>';
echo '</thead>';
echo '<tbody>';

...
<?php
$inputValue = strtolower(htmlspecialchars($_GET['searchArtist']));
...
$stid = oci_parse($conn, "SELECT UNIQUE ARTIST.ARTIST_NAME,
 ARTIST.ARTIST_DOD,ARTIST.ARTIST_ARTPLACE
, ARTIST.ARTIST_COUNTRY FROM ARTIST WHERE ARTIST_NAME
LIKE '%" . $_GET['searchArtist'] . "%' ");
...
$stid = oci_parse($conn, "SELECT UNIQUE ARTIST.ARTIST_NAME,
 ARTIST.ARTIST_DOB,ARTIST.ARTIST_ARTPLACE
, ARTIST.ARTIST_COUNTRY FROM ARTIST WHERE ARTIST_NAME
LIKE '%" . $_GET['searchArtist'] . "%' ");
...
echo '<thead>';
echo '<tr>';
echo '<th class="active">Artist Name</th>';
echo '<th class="active">Artist Birthday</th>';
echo '<th class="active">Artist Art Place</th>';
echo '<th class="active">Artist Country</th>';
echo '</tr>';
echo '</thead>';
echo '<tbody>';

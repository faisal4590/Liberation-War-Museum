...
<?php
$inputValue = strtolower(htmlspecialchars($_GET['searchGallery']));
...
$stid = oci_parse($conn, "SELECT GALLERY_NO,
 GALLERY.GALLERY_NAME,GALLERY.INAGURATED_BY FROM GALLERY WHERE GALLERY.GALLERY_NAME
LIKE '%" . $_GET['searchGallery'] . "%' ");
...
echo '<thead>';
echo '<tr>';
echo '<th class="active">Gallery No</th>';
echo '<th class="active">Gallery Name</th>';
echo '<th class="active">Inagurated By</th>';
echo '</tr>';
echo '</thead>';
echo '<tbody>';

...
<?php
$searchValue    = strtolower(htmlspecialchars($_GET['searchValue']));
$employee       = strtolower(htmlspecialchars($_GET['employee']));
$freedomFighter = strtolower(htmlspecialchars($_GET['freedomFighter']));
...
else
{
    if ($employee == '' && $freedomFighter != '')
    {
        $stid = oci_parse($conn, "SELECT FREEDOM_FIGHTERS.FREEDOM_FIGHTER_NAME,
             FREEDOM_FIGHTERS.FREEDOM_FIGHTER_COUNTRY,
             FREEDOM_FIGHTERS.FREEDOM_FIGHTER_DOB
              FROM FREEDOM_FIGHTERS WHERE FREEDOM_FIGHTERS.FREEDOM_FIGHTER_NAME
            LIKE '%" . $_GET['freedomFighter'] . "%' ");

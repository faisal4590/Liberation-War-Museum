...
<?php
$inputValue = strtolower(htmlspecialchars($_GET['searchFreedomFighter']));
...
$stid = oci_parse($conn, "SELECT  FREEDOM_FIGHTERS.FREEDOM_FIGHTER_NAME,
 FREEDOM_FIGHTERS.FREEDOM_FIGHTER_DOB,FREEDOM_FIGHTERS.FREEDOM_FIGHTER_GENDER
, FREEDOM_FIGHTERS.FREEDOM_FIGHTER_COUNTRY FROM FREEDOM_FIGHTERS WHERE FREEDOM_FIGHTER_NAME
LIKE LOWER('%" . $_GET['searchFreedomFighter'] . "%')  ");
...
$stid = oci_parse($conn, "SELECT FREEDOM_FIGHTERS.FREEDOM_FIGHTER_NAME ,
 FREEDOM_FIGHTERS.FREEDOM_FIGHTER_DOB,FREEDOM_FIGHTERS.FREEDOM_FIGHTER_GENDER
, FREEDOM_FIGHTERS.FREEDOM_FIGHTER_COUNTRY FROM FREEDOM_FIGHTERS WHERE 
...
echo '<thead>';
echo '<tr>';
echo '<th class="active">Freedom Fighter Name</th>';
echo '<th class="active">Freedom Fighter Gender</th>';
echo '<th class="active">Freedom Fighter Birthday</th>';
echo '<th class="active">Freedom Fighter Country</th>';
echo '</tr>';
echo '</thead>';
echo '<tbody>';

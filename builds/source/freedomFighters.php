        ...
        <div class="row">
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse menu" id="bs-example-navbar-collapse-1">
                    ...
                    <form class="navbar-form navbar-left" role="search" action="processSearchFreedomFighters.php">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Search by freedom fighter name"
                                   name="searchFreedomFighter">
                        </div>
...
Freedom Fighters Who Got Gallantry Award Under A Specific Sector</h1>';
...
echo '<th>Martyr Date Of Birth</th>';
echo '<th>Date Of Martyrdom</th>';
...
echo '<h1 class="text-center text-success" style="margin-bottom: 30px;">
Freedom Fighters Children Info</h1>';

$conn = oci_connect("system", "faisal4590", "localhost/faisal");
$stid = oci_parse($conn,
    'SELECT
  FREEDOM_FIGHTER_NAME,
  FREEDOM_FIGHTER_GENDER,
  CHILDREN_NAME,
  CHILDREN_GENDER,
  CHILDREN_DOB
FROM
  FREEDOM_FIGHTERS JOIN FREEDOM_FIGHTERS_CHILDREN
    ON FREEDOM_FIGHTERS.FREEDOM_FIGHTER_ID
       = FREEDOM_FIGHTERS_CHILDREN.FREEDOM_FIGHTER_ID');
...
echo '<thead>';
echo '<tr>';
echo '<th>Freedom Fighter Name</th>';
echo '<th>Freedom Fighter Gender</th>';
echo '<th>Freedom Fighter Children Name</th>';
echo '<th>Freedom Fighter Children Gender</th>';
echo '<th>Freedom Fighter Children Date Of Birth</th>';

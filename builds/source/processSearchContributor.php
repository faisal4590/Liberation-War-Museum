...
<?php
$inputValue = strtolower(htmlspecialchars($_GET['searchContributor']));
...
$stid = oci_parse($conn, "SELECT UNIQUE CONTRIBUTORS.CONTRIBUTOR_NAME,
CONTRIBUTORS.CONTRUBITOR_DOB,CONTRIBUTORS.PROFESSION
 FROM CONTRIBUTORS WHERE CONTRIBUTORS.CONTRIBUTOR_NAME
LIKE '%" . $_GET['searchContributor'] . "%' ");
...
echo '<thead>';
echo '<tr>';
echo '<th class="active">Contributor Name</th>';
echo '<th class="active">Freedom Fighter Birthday</th>';
echo '<th class="active">Freedom Fighter Profession</th>';
echo '</tr>';
echo '</thead>';
echo '<tbody>';
